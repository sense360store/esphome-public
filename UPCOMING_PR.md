...
- **FW-MATRIX-001 — generated firmware combination readiness
  ...
  **FW-MATRIX-002 — firmware build-gap report landed as PR #540
  ...
  rows. The next planning-step pointer is **KIT-MATRIX-001 —
  Define productized kit/bundle intent matrix** (tentative
  name), a future docs-only PR that would map the 168 enumerated
  combinations into productized kit / bundle intent groups so
  product / WebFlash / release sequencing can pull from a
...
21. **HW-005 / HW-PINMAP-320-FOLLOWUP**
...
25. **WF-TRIAC-001 — In-repo wrapper/catalog/build slice**
