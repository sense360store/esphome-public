...
**landed PR #573**) → `FW-COMPILE-DAC-001` (**landed this PR** —
`voltage:` `0-10V` → `10V` enum fix applied + `Ceiling-POE-FanDAC`
compile-only target added; CI `--compile` pass pending) →
`PRODUCT-DAC-001` (canonical product YAML;
