...
|--------|-----|---------------------|------------------------------------|
| Core | S360-100 | ✅ `s360-100-core-ceiling.yaml` | — (relay + health entities present) |
...
- [`docs/hardware/board-readiness-matrix.md` (archived)](archive-index.md) and [`docs/hardware/package-readiness-matrix.md` (archived)](archive-index.md) — pin-map / package readiness gates feeding the `needs-schematic-reconcile` rows.
