...
|---|---|---|---|
| `Ceiling-POE-VentIQ-FanTRIAC-RoomIQ` | experimental | § `ceiling-poe-ventiq-fantriac-roomiq` (below, marked section) | Sense360 TRIAC (`S360-320`) |
...
> index page for the experimental lane.** The former per-config draft
> file was collapsed into the marked section below (owner decision of
> 2026-07-30); the draft body and all warning copy are preserved
> verbatim inside `<!-- draft:<Config-String>:start/end -->` markers.
