...
| Field          | Value                          |
| -------------- | ------------------------------ |
| Schematic file | [`schematics/S360-200-R4.pdf`](../../hardware-artifacts/schematics/S360-200-R4.pdf) |
...
> to this repo at [`schematics/S360-200-R4.pdf`](../../hardware-artifacts/schematics/S360-200-R4.pdf).
