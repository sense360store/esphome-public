...
| `compile-only.yml` (full lane) | **workflow_dispatch `compile_mode=full` only** | `esphome compile` of all 10 targets (manual) — CI e.g. run `26414398902` (10 targets); earlier run `26364679370` (9 targets). Also run **locally** 2026-05-27 (ESPHome 2026.4.5, 10/10 `rc=0`, **no CI run id**) — see [`product-readiness-matrix.md` §FW-FULL-COMPILE-NOWEBFLASH-001](product-readiness-matrix.md#fw-full-compile-nowebflash-001--recorded-full-esphome-compile-evidence-for-the-compile-only-lane-2026-05-27) | nothing automatically on PR |
