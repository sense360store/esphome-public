...
- **FanPWM bench result is now recorded** (`S360-311-BENCH-RESULT-001`,
  ...
  **`S360-311-CURRENT-THERMAL-EVIDENCE-REQUEST-001`** (2026-05-27; §5C), so
...
### 5C. S360-311-CURRENT-THERMAL-EVIDENCE-REQUEST-001 — FanPWM current & thermal checklist & contract (2026-05-27)
