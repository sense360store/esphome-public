...
**Audit basis:** [`docs/security/SECURITY-AUDIT-2026-06.md`](SECURITY-AUDIT-2026-06.md)
...
formerly the root-level copy's sibling at this same path and archived
under the docs cleanup pass (see [`docs/archive-index.md`](../archive-index.md));
...
handoff procedure in the earlier plan document (§"SHA-256 handoff for the
WebFlash re-import"; archived — see
...
[`docs/security/release-firmware-credential-posture.md`](release-firmware-credential-posture.md).
